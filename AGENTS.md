...
This project is indexed by GitNexus as **dashboard** (3287 symbols, 5316 relationships, 116 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
